...
#
# Three gates end in something only a person holding hardware can produce:
# P4's MB/s from a physical iPhone, P5's force-quit run, P6's session with
# somebody who has never seen the app. None of them can be produced by a
